<template>
    ...
    <div>
        ...
        <div class="flex justify-between">
            <div v-on:click="activetab=1" v-bind:class="[ activetab === 1 ? 'active' : '' ]" class="text-center">Tab 1</div>
            <div v-on:click="activetab=2" v-bind:class="[ activetab === 2 ? 'active' : '' ]" class="text-center">Tab 2</div>
            <hr>
        </div>

        <div v-if="activetab === 1" class="bg-white rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
        ...
        <div v-if="activetab === 2" class="bg-white rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2 text-left" for="grid-first-name">
                        First Name
